...
export const locations: Location[] = [
  ...
  },
  {
    sido: "경기도",
    sigungu: [
      "수원시", "수원시 장안구", "수원시 권선구", "수원시 팔달구", "수원시 영통구", "성남시", "성남시 수정구", "성남시 중원구", "성남시 분당구", "안양시", "안양시 만안구", "안양시 동안구", "안산시", "안산시 상록구", "안산시 단원구", "용인시", "용인시 처인구", "용인시 기흥구", "용인시 수지구", "부천시", "광명시", "평택시", "과천시", "오산시", "시흥시", "군포시", "의왕시", "하남시", "이천시", "안성시", "김포시", "화성시", "광주시", "여주시", "양평군", "고양시", "고양시 덕양구", "고양시 일산동구", "고양시 일산서구", "의정부시", "동두천시", "구리시", "남양주시", "파주시", "양주시", "포천시", "연천군", "가평군"
    ]
  },
  {
    sido: "강원도",
  ...
  },
  {
    sido: "충청북도",
    sigungu: [
      "청주시", "청주시 상당구", "청주시 흥덕구", "청주시 서원구", "청주시 청원구", "충주시", "제천시", "보은군", "옥천군", "영동군", "증평군", "진천군", "괴산군", "음성군", "단양군"
    ]
  },
  {
    sido: "충청남도",
